...
<head>
    <title>Học phần của bạn | Quizlet</title>
    ...
    <link rel="stylesheet" type="text/css" href="https://quizlet.com/a/c/dashboard/index.TRUJt.n.css">
    ...
    <script>
        ! function(e, t, r, n, a) {
            if (!e[a]) {
                ...
                o.async = !0, o.src = '/static/delightedv1.0.1a.min.js';
                var p = t.getElementsByTagName('script')[0];
                p.parentNode.insertBefore(o, p)
            }
        }(window, document, ['survey', 'reset', 'config', 'init', 'set', 'get', 'event', 'identify', 'track', 'page', 'screen', 'group', 'alias'], 'RB3HtsSckpMklXUg', 'delighted');
        delighted.survey({
            "createdAt": "2018-11-02T20:17:46-07:00",
            "sampleFactor": 1,
            "email": "hoangkhai1411111998@gmail.com",
            "name": "quizlette56570074",
            "properties": {
                "countryCode": "vn",
                "locale": "vi",
                "loggedIn": "Logged In",
                "questionProductName": "Quizlet",
                "uid": "-3395576602222604931",
                "localHourRange": "Night (10pm to 7am)",
                "dayOfWeek": "Saturday",
                "accountLifetimeRange": "Less than 24 hours",
                "ageRange": "18-24",
    ...
    <script>
        var Quizlet = {
            ...
            "cloudFlareRay": "473c045c2ab9a31a-DEN",
            "didJustUpgrade": null,
            "uid": "-3395576602222604931",
            "user": {
                "id": 103850334,
            ...
            "adConfig": {
                ...
                "registeredAds": {
                    ...
                    "MWebHomepageEmbedded": {
                        "isFlexible": true,
                        "showAdHeading": true,
                        "supportsVideo": false,
                        "useHeaderBidding": false,
                        "type": "MOBILE_HORIZONTAL_STRIP"
                    }
                },
            ...
            "extraSessionUUIDs": ["f0e9fb9a-5013-4f53-bcb5-23f892317850", "2aee54e3-fc0c-4d1b-bbf9-1d585b1edb69", "fd8e18b1-7e26-46a4-80ea-23555bab64bd", "4bef130e-be02-4cf1-aaec-085ee1cdbc21", "766d11c4-bfde-45b3-86fd-11400f6ad378"],
            "countryCode": "vn",
            "lowerTeacherAgeBound": 22,
            "upperTeacherAgeBound": 80,
            "requestId": "d4CjA34WMaThm8ZCzX9c",
            "colorTheme": "default",
            "upgradeData": {
                "freeTrial": null
            }
        };
        Quizlet.actionString = "\"logged-in-hp\"".replace(/"/g, '/');
    </script>
    <script>
        window.ga = function() {
    ...
    <script async src="https://www.googletagservices.com/tag/js/gpt.js" defer></script>
    ...
    <script async src="/a/j/dist/dashboard.d48bbba57c73f0a45f65.a.vi.js" defer integrity="sha512-rSLo6S8wSUeRNyIOWemvgPe6wn5RfmuXHke1qsT+7ss4jCsN5LDtVYEphkQ3S4vZkbKX5bCjsXx3WqJk1pRE0Q=="></script>
    <script async src="/a/j/dist/study_feed.fe43ba795efc030.a.vi.js" defer integrity="sha512-tzEyKHzMtPpDX1LkdSkUM59nNwQW+yruYOHifJTb00JSrSqd0fziObrU1yKLii7zomV5RapJ8vsXyCKyiEHFzw=="></script>
    ...
    <script async src="/a/j/dist/quizlet_global.3da264e3d8bd9ca443cb.a.vi.js" defer integrity="sha512-hhbp3sC4hMCzK0pn1R7iGMlvizwr8/q+ux6Jz0vlQX4pUGnaZ9q4BpnGg7nbK3CsvFFWZIijg+3aio2iFBiVwA=="></script>
...
<body class="study_feed latest_activity has-no-footer qad-is-showing" itemscope itemtype="http://schema.org/WebPage">
...
<div class="site">
    ...
    </script><img class="PrintLogo" id="Qq7ZtFUVRhS">
    <script>
        QWait("dom", function() {
            document.getElementById("Qq7ZtFUVRhS").setAttribute("src", "\/a\/i\/logo\/Quizlet-print.68Eu.png")
        });
    </script>
    <div class="DashboardLayout">
        <div class="DashboardLayout-container">
            <div id="DashboardSidebarTarget" class="DashboardLayout-sidebar"></div>
            <div id="DashboardPageTarget" class="DashboardLayout-main"></div>
        </div>
    </div>
    <script>
        window.Quizlet["dashboardData"] = {
            "onboardingSteps": [],
            ...
            "firstSetClassProgressPath": null,
            "formattedTeacherUpsellMonthlyPrice": "3\u00a0US$",
            "upsellInterstitialModalData": {
                "shouldShow": false
            },
            "subscriptionRenewalModalData": {
                "daysBeforeExpiration": null,
                "shouldShow": false,
                "showPlus": false,
                "showTeacher": false
            },
            "title": "H\u1ecdc ph\u1ea7n c\u1ee7a b\u1ea1n | Quizlet",
            "classMemberships": [],
            "models": {
                "image": [],
                "imageRef": []
            ...
            "isTeacher": false,
            "shouldShowSpecificContentUpsell": false,
            "shouldShowAd": true,
            "shouldShowBanner": false,
            "shouldShowRenewPlusBanner": false,
            "shouldShowRenewTeacherBanner": false,
            "specificContentRecommendations": [],
            "unpublishedSets": [{
                "id": 335847325,
