                            ...
                            <div class="UIContainer">
                                <div class="CreateSetHeader-headingText">
                                    <div class="CreateSetHeader-heading">
                                        <div class="CreateSetHeader-title">Nhập số nhiệm vụ vào: </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="CreateSetPage-container" style="background-color:#fff">
                    <div class="UIContainer">
                        ...
                        <form action="{{ route('showInput') }}">
                            ...
                            <input type="submit" value="done" style="background-color: #4aa0e6; width: 80px; height: 30px; border: 1px solid black; border-radius: 5px">
                        </form>
